...
return new class extends Migration
{
    public function up()
    {
        Schema::table('documents', function (Blueprint $table) {
            ...
            $table->dropForeign('documents_owner_id_foreign');

            // 2. Rename the column
            $table->renameColumn('owner_id', 'user_id');

            // 3. Add the new foreign key with the correct index name
...
current_sharing as (
select
	c.team_id, last_day(d.posting_date - interval 1 month) + interval 1 day firstday, i.category_id, d.user_id, 
